...
#[test]
#[ignore = "Scenario B (T2.3): production LSTM condition_dsp diverges from oracle (ESR≈1.3e-1, ratio 187051x). Frame 0 matches, frame 1 diverges — LSTM state update bug. Decomposition proves it's not numerical. Oracle anchor passes at 5e-16. Root cause not yet identified; suspected in static LSTM 1x3 model or state interaction with chunked WaveNet processing. Model is unreliable — T3.1 policy needed."]
