...
| `wavenet_a2_max.nam`        | Official Real    | WaveNet (CH=4, cond=8 FiLM)                                    | N/A (Disabled — confirmed broken audio output (§7.1); fixture retained, not removed) | Steve Atkinson official example. CC0.                                    | Disabled fail-closed at dispatch; ver `TODO-sprints.md` S1 e `docs/cpp_parity_map.md` §7.1. |
