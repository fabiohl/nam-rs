...
## E1 — Correção de artefatos de áudio no caminho de transição (DSP) 🔴 [DOING]
...
## E2 — Endurecimento de contratos `unsafe` e ordenação de memória 🟡 [DONE]
...
## E3 — Honestidade de telemetria e _test oracles_ 🟡 [DONE]
