...
**Todas as políticas, regras, skills e workflows estão em [`.agents/`](.agents/). Consulte o diretório para documentação completa.**
...
| `.agents/workflows/` | Receitas procedurais que encadeiam skills                                               |
