...
* If a "task" [or any atomic activity with instruction] is provided (Examples: "Task 1.2" or "[T9]"): The goal is the implementation of this task as explained in its description. Use the `implementador` skill to execute it.
* If a "sprint" or "epic" [or any artifact containg sub-tasks] is provided (Examples: "Sprint 1" or "Epic 3"): The goal is to review/audit the entire sprint/epic to ensure that all micro and macro objectives of that sprint (as well as its tasks) have been exemplarily fulfilled.
...
* Know the context of the sprints, epics and whole TODO-?.md file the task is inserted. Make informed decisions.
...
* At the end of completing activities, if there is important information impacting other activities planned for later, leave a note in the most appropriate location in TODO-?.md.
