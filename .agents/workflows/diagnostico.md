---
description: Diagnostic from NAM-rs error message. Paste the support block and the AI performs full triage.
---

# NAM-rs Error Diagnostic

Workflow for when the user pastes an error message/support block generated by NAM-rs.
...
4. If the user approves, create the task using the `/tarefa` workflow or proceed directly to the fix using the `implementador` skill.
