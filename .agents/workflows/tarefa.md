...
Ao final da conclusão das atividades, se houver alguma obervação relevante a ser deixada para as próximas tarefas, deixar anotado no /TODO-sprints.md como uma nota logo abaixo da definição da tarefa/sprint solicitada.
