...
| **`cpp_parity`**                    | Integration | *None*                      | No                        | **Yes** (`quick_parity`) | No                              | **Yes** (Phase 3, ignored)           | Live parity checking of WaveNet (A1/A2) and LSTM models against C++ counterpart. Quick subset (5 models) in Fase 2; full matrix in long.               |
...
| **`tests/cpp_parity.rs`**                     | `live_cross_validation_*` (full matrix)                                                                                | Compiles and runs live comparisons against C++ toolchain (requires C++ compiler). The `quick_parity` subset (5 models) runs in Fase 2.                | Quick Fase 2 (`quick_parity`), Long Suite (Phase 3, full) | Per-commit, Nightly   |
