...
| **`cpp_parity`**                 | Integration | *None*                      | **Yes**             | No                | Live parity checking of WaveNet and LSTM models against C++ counterpart       |
...
| **`golden_vectors`**             | Integration | *None*                      | **Yes**             | No                | Structural testing of model loaders and numerical drift against known outputs |
...
| **`soak_test`**                  | Integration | *None*                      | **Yes** *(Ignored)* | No                | Dynamic long-duration soak testing under varying input signals                |
